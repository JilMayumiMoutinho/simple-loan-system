...
//cuidado pra não importar do jupiter
...
@ActiveProfiles("test")
//teste integrado, ou seja com DB, ou seja com spring
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
//não substitui nada, usa como na config

class CreditRepositoryTest {
    @Autowired lateinit var creditRepository: CreditRepository
    @Autowired lateinit var testEntityManager: TestEntityManager
    //Injetar o customer e testEntity pra poder ter acesso aos metodos que existem neles
    ...
    //Criando no 'db' um cliente e dois créditos para ele
...
//CustomerRepo não tem pq foi realizado com o JPA